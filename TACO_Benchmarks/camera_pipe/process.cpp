...
#include "camera_pipe_auto_schedule_store.h"
#include "camera_pipe_auto_schedule.h"
#include "camera_pipe_simple_auto_schedule.h"
#include "camera_pipe_auto_schedule_no_fus.h"
#endif
...
//
    ...
    {"Manual", [&]() { camera_pipe(input, matrix_3200, matrix_7000, color_temp, gamma, contrast, sharpen, blackLevel, whiteLevel, output); output.device_sync(); }},
        {"Nested auto-scheduled", [&]() { camera_pipe_auto_schedule_store(input, matrix_3200, matrix_7000, color_temp, gamma, contrast, sharpen, blackLevel, whiteLevel, output); output.device_sync(); }},
      {"No-fusion auto-scheduled", [&]() { camera_pipe_auto_schedule_no_fus(input, matrix_3200, matrix_7000, color_temp, gamma, contrast, sharpen, blackLevel, whiteLevel, output); output.device_sync(); }},
