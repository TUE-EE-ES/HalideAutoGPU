...
public:
    ...
    void generate() {
        ...
        Func clamped("repeat_edge");
       clamped	= Halide::BoundaryConditions::repeat_edge(input_);
...
*/
        ...
        // Estimates (for autoscheduler; ignored otherwise)
        {
            ...
            normalize.dim(0).set_bounds_estimate(0, 1536)
                  .dim(1).set_bounds_estimate(0, 2560)
