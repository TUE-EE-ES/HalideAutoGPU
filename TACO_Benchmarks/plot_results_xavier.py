...
ratio_s=np.minimum(auto[:12],nested[:12])/simple[:12]
...
plt.legend((rects1[0], rects2[0],rects3[0],rects4[0],rects5[0]), ('AutoGPU (Overlap)','AutoGPU (Nested)','AutoGPU (w/o Fus)','Manual','Grad autosched'),bbox_to_anchor=(2.75,1.35),fancybox=True,edgecolor='black',fontsize='medium',ncol=1)
        #plt.tight_layout()
...
plt.savefig("results4_xavier_plt.pdf")
plt.show()
