...
#include "unsharp.h"
#include "unsharp_auto_schedule_store.h"
#include "unsharp_auto_schedule.h"
#include "unsharp_simple_auto_schedule.h"
#include "unsharp_auto_schedule_no_fus.h"
...
int main(int argc, char **argv) {
    ...
    multi_way_bench({
        ...
        {"Nested auto-scheduled", [&]() { unsharp_auto_schedule_store(input, output); output.device_sync(); }},
       {"Auto-scheduled", [&]() { unsharp_auto_schedule(input, output); output.device_sync(); }},
        ...
        {"No-fusion auto-scheduled", [&]() {unsharp_auto_schedule_no_fus(input, output); output.device_sync(); }}
